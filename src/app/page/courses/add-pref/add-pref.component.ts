...
@Component({
  selector: 'app-add-pref',
  templateUrl: './add-pref.component.html',
  styleUrls: ['./add-pref.component.scss'],
  providers: [MessageService]
})
export class AddPrefComponent {
  ...
  ngOnInit(): void {
    this.items = [{ label: 'Course List', routerLink: '/course' }, { label: 'Add Pref' }];
    this.getRooms();
  ...
  onSubmit() {
    ...
    this.courseService.savePref(this.course).subscribe((res:any) => {
